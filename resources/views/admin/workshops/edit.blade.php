...
<head>
    ...
    <title>แก้ไขเวิร์กชอป - {{ $workshop->title }}</title>
            ...
            <div class="p-10 md:p-16">
                <form id="edit-workshop-form" action="{{ route('workshops.update', $workshop) }}" method="POST" class="space-y-10">
                    ...
                    <div class="space-y-3">
                        ...
                        <input type="text" name="title" id="title" value="{{ $workshop->title }}" required 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-3">
                            ...
                            <input type="text" name="speaker" id="speaker" value="{{ $workshop->speaker }}" required 
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="text" name="location" id="location" value="{{ $workshop->location }}" required 
                                class="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all placeholder:text-slate-300 font-bold" 
                    ...
                    <div class="space-y-3">
                        ...
                        <textarea name="description" id="description" rows="5" 
                            ...
                            placeholder="รายละเอียดกิจกรรม...">{{ $workshop->description }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div class="space-y-3">
                            ...
                            <input type="number" name="capacity" id="capacity" value="{{ $workshop->capacity }}" required min="1" 
                                class="w-full px-6 py-4 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none transition-all placeholder:text-slate-300 font-bold" 
                                placeholder="เช่น 20">
                        </div>
                        <div class="space-y-3">
                            ...
                            <input type="datetime-local" name="scheduled_at" id="scheduled_at" value="{{ $workshop->scheduled_at->format('Y-m-d\TH:i') }}" required 
